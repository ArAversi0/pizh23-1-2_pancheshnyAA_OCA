...
REPORT_DIR = BASE_DIR / "report"                    # project_root/report
...
def compare_fibonacci():
    ...
    plt.legend()
    plt.grid(True)
    out1 = REPORT_DIR / 'fib_recursion_vs_dp.png'
    plt.savefig(str(out1))
    plt.close()
    ...
    plt.legend()
    plt.grid(True)
    out2 = REPORT_DIR / 'fib_dp_methods.png'
