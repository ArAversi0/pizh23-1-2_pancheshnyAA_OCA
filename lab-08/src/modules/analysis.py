...
def measure_huffman_performance():
    ...
    # --- Корректный путь: ../../report/huffman_performance.png ---
    base_dir = os.path.dirname(__file__)
    report_dir = os.path.normpath(os.path.join(base_dir, "..", "..", "report"))
    os.makedirs(report_dir, exist_ok=True)

    output_path = os.path.join(report_dir, "huffman_performance.png")
