...
![collision_hist_simple](report/collision_histogram_simple_hash.png)
![collision_hist_poly](report/collision_histogram_poly_hash.png)
![collision_hist_djb2](report/collision_histogram_djb2.png)

### 2. Время вставки при разном коэффициенте заполнения  
*(chaining vs open addressing)*

![insert_time](report/lab05_insert_time.png)
