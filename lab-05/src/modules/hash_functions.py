...
def djb2(s: str, mod: int) -> int:
    ...
    h = 5381
    for ch in s:
        # (h << 5) эквивалентно умножению на 32
        h = (h << 5) + h + ord(ch)
    return h % mod
...
if __name__ == "__main__":
    ...
    print("simple_hash('hello') =", simple_hash("hello", MODULO))
    print("poly_hash('hello') =", poly_hash("hello", MODULO))
    print("djb2('hello') =", djb2("hello", MODULO))